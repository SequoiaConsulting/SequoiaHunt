...
function logger()
{
	...
	$query = "insert into logger (ip_addr, emp_eemail, ref_url, ref_detail, login_out) values('" . $ip_addr . "','" . $emp_email . "','" . $file_name . "','" . $ref_details . "',0 )";
	//echo $query;
		...
		<tr>
			<td width="80%" height="600px" valign="top">
				...
				<table height="500px" width="70%">
					<tr>
						<td align="center">
							<img src="./img/temple.png" width="400" height="230">
						</td>
					</tr>
					<tr>
						<td align="center">
			...
			<div class="silverheader"><a href="#">Your current Level #9</a></div>
